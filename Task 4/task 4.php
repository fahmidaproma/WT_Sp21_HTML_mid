	...
	<legend><h1>Club Member Registration</h1></legend>
		<form action="" method="post">
			...
			<tr>
				...
				<td>:<input type="text" placeholder="Name" name="name" value="<?php echo $nam?>"
				<span><?php echo $namErr?></span></td>
			...
			<tr>
                ...
                <td>:
			       <input type="number" placeholder="Code" name="Code" value="<?php echo $code?>"
				   <span><?php echo $codeErr?></span></td>
			...
			<tr>
				...
				<td>:
				    <input type="text" placeholder="Street Address" name="add" value="<?php echo $add?>"
				    <span><?php echo $addErr?></span></td>
			<tr>
				<td>:
				    <input type="Text" placeholder="City" name="City" value="<?php echo $city?>"
					<span><?php echo $cityErr?></span></td>
					<td>-<input type="Text" placeholder="State" name="State" value="<?php echo $State?>"
					<span><?php echo $StateErr?></span></td>
					<td><input type="Text" placeholder="Poatal/Zip Code" name="Poatal/Zip Code"" value="<?php echo $p?>"
					<span><?php echo$pErr?></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>  <ol><input type="checkbox" value="A Friend or Colleague" name="Where did you hear about us?[]"> A Friend or Colleague</ol>
